...
import dev.abhi.zmt.core.common.PermissionGrants
import dev.abhi.zmt.core.common.TuiKey
import dev.abhi.zmt.core.common.generateAsciiPlaceholder
import dev.abhi.zmt.core.common.generateCoverPlaceholder
import dev.abhi.zmt.core.common.isLandscapeWindow
import dev.abhi.zmt.core.common.rememberPermissionGrants
...
import dev.abhi.zmt.presentation.settings.FILES_ENTRY
import dev.abhi.zmt.presentation.settings.PERMISSION_REGISTRY
import dev.abhi.zmt.presentation.settings.PermissionEntry
import dev.abhi.zmt.presentation.settings.PermissionRow
import dev.abhi.zmt.presentation.settings.SettingRow
import dev.abhi.zmt.presentation.settings.SyncPermissionState
import dev.abhi.zmt.presentation.settings.markWidth
import dev.abhi.zmt.presentation.settings.nextCoverCols
...
fun SetupScreen(state: DmtState, dispatch: (DmtAction) -> Unit) {
    ...
    if (isLandscapeWindow()) {
        ...
        Column(modifier = root) {
            SetupTitlebar(label = stringResource(R.string.page_setup))
