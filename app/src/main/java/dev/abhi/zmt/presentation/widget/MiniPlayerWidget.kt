package dev.abhi.zmt.presentation.widget
...
class MiniPlayerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val ACTION_PLAY_PAUSE = "dev.abhi.zmt.ACTION_PLAY_PAUSE"
        private const val ACTION_NEXT = "dev.abhi.zmt.ACTION_NEXT"
        private const val ACTION_PREV = "dev.abhi.zmt.ACTION_PREV"
